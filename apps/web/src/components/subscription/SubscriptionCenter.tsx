...
const extensions = [
  ...
  { icon: "phone", tone: "orange", title: "Телефония", kind: "Коммуникации", description: "Входящие звонки, записи разговоров и привязка к сделкам.", price: "от $12 / номер", status: "Подключение специалистом" },
