...
export interface CreateDevelopmentDeveloperRequest {
  name: string;
  description?: string | null;
  website?: string | null;
  phone?: string | null;
...
export type UpdateDevelopmentDeveloperRequest = Partial<CreateDevelopmentDeveloperRequest>;
...
export type UpdateDevelopmentProjectRequest = Partial<CreateDevelopmentProjectRequest>;
