...
CRM для агентств недвижимости. Текущий frontend-прототип включает воронку, контакты, каталог объектов, центр задач и календарь. Backend, импорт, Meta Lead Ads и Telegram-уведомления будут подключаться следующими этапами.
