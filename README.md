...
Актуальная граница готовности — **рабочий пилот**: системой уже пользуется команда примерно из восьми сотрудников. Основной разработческий контур готов: лиды, роли, контакты, сделки, задачи, рабочий каталог, архив объектов и публичные подборки. Неполным продуктовым блоком остаются новостройки: сейчас это плоские первичные объекты, без отдельной модели проекта, корпуса и юнитов. Проверка командой, безопасность развёртывания и восстановление из резервной копии относятся к приёмке и эксплуатации, а не к перечню незавершённых функций. Instagram Direct, телефония и платежи не входят в текущий обязательный объём.
